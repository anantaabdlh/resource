...
mkdir -p $HOME/$ARKH_FOLDER/$BINARY/genesis/bin
mv $ARKH $HOME/$ARKH_FOLDER/$BINARY/genesis/bin/

# Create application symlinks
ln -s $HOME/$ARKH_FOLDER/$BINARY/genesis $HOME/$ARKH_FOLDER/$BINARY/current
sudo ln -s $HOME/$ARKH_FOLDER/$BINARY/current/bin/$ARKH /usr/bin/$ARKH
...
RestartSec=10
LimitNOFILE=65535
Environment="DAEMON_HOME=$HOME/$ARKH_FOLDER"
Environment="DAEMON_NAME=$ARKH"
...
echo ""
echo -e "CHECK STATUS BINARY : \e[1m\e[31msystemctl status $ARKH\e[0m"
