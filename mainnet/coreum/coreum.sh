...
SEEDS=9336e90eb221ce9851fe16e391cebb8d819dd972@seeds-coreum.sxlzptprjkt.xyz:29656
...
$CORE tendermint unsafe-reset-all --home $HOME/$CORE_FOLDER/$CORE_ID --keep-addr-book
curl -L https://snap.nodexcapital.com/coreum/coreum-latest.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/$CORE_FOLDER/$CORE_ID
