...
echo "░  ░  ░   ░    ░    ░ ░   ░      ░      ░   ░ ░   ░   ░ ░        ";
echo "      ░   ░    ░      ░  ░       ░            ░     ░          ░ ";
echo "         Auto Installer ojo-devnet {price feeder} v0.1.1         ";
echo -e "\e[0m"
sleep 1
...
$OJO tx bank send wallet $OJO_PRICEFEEDER_ADDRESS 1000000uojo --from $OJO_WALLET1 --chain-id $OJO_ID -y

# Delegate pricefeeder responsibility
$OJO tx oracle delegate-feed-consent $OJO_MAIN_WALLET_ADDRESS $OJO_PRICEFEEDER_ADDRESS --from $OJO_WALLET1 -y
