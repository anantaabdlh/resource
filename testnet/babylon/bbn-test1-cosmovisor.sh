...
echo "░  ░  ░   ░    ░    ░ ░   ░      ░      ░   ░ ░   ░   ░ ░        ";
echo "      ░   ░    ░      ░  ░       ░            ░     ░          ░ ";
echo "     Auto Installer bbn-test1 {cosmovisor} For BABYLON v0.5.0    ";
echo -e "\e[0m"
sleep 1
...
BBN_GENESIS=https://raw.githubusercontent.com/sxlzptprjkt/resource/master/testnet/babylon/genesis.json
...
mkdir -p $HOME/$BBN_FOLDER/$BINARY/genesis/bin
mv build/$BBN $HOME/$BBN_FOLDER/$BINARY/genesis/bin/

# Create application symlinks
ln -s $HOME/$BBN_FOLDER/$BINARY/genesis $HOME/$BBN_FOLDER/$BINARY/current
sudo ln -s $HOME/$BBN_FOLDER/$BINARY/current/bin/$BBN /usr/bin/$BBN
...
RestartSec=10
LimitNOFILE=65535
Environment="DAEMON_HOME=$HOME/$BBN_FOLDER"
Environment="DAEMON_NAME=$BBN"
...
echo ""
echo -e "CHECK STATUS BINARY : \e[1m\e[31msystemctl status $BBN\e[0m"
