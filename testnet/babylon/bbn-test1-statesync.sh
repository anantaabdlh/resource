...
echo "░  ░  ░   ░    ░    ░ ░   ░      ░      ░   ░ ░   ░   ░ ░        ";
echo "      ░   ░    ░      ░  ░       ░            ░     ░          ░ ";
echo "           Auto Installer bbn-test1 For BABYLON v0.5.0           ";
echo -e "\e[0m"
sleep 1
...
# Set peers and seeds
PEERS="4ffd7f9202c58df4afec210f22da732023e476c8@46.101.144.90:24656"
...
s|^(trust_hash[[:space:]]+=[[:space:]]+).*$|\1\"$TRUST_HASH\"|" $HOME/$BBN_FOLDER/config/app.toml
