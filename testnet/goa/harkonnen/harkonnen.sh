...
HARKONNEN_GENESIS=https://raw.githubusercontent.com/sxlzptprjkt/resource/master/testnet/goa/harkonnen/genesis.json
HARKONNEN_ADDRBOOK=https://raw.githubusercontent.com/sxlzptprjkt/resource/master/testnet/goa/harkonnen/addrbook.json
...
echo "export HARKONNEN_GENESIS=${HARKONNEN_GENESIS}" >> $HOME/.bash_profile
echo "export HARKONNEN_ADDRBOOK=${HARKONNEN_ADDRBOOK}" >> $HOME/.bash_profile
...
curl -Ls $HARKONNEN_GENESIS > $HOME/$HARKONNEN_FOLDER/config/genesis.json
curl -Ls $HARKONNEN_ADDRBOOK > $HOME/$HARKONNEN_FOLDER/config/addrbook.json
